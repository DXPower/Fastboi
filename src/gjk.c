...
int gjk (const vec2 * vertices1, size_t count1,
		 const vec2 * vertices2, size_t count2, struct gjk_vec2 * finalSimplexOut) {
	...
	memcpy(finalSimplexOut, simplex, sizeof(simplex[0]) * 3);
