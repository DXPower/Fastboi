...
CXX=clang++
CFLAGS = -std=c11
CXXFLAGS = -std=c++20 -O0 -m64 -march=x86-64 -Wfatal-errors -W -Wdelete-abstract-non-virtual-dtor -Wno-unused-parameter -Wno-format -Xclang -flto-visibility-public-std -frelaxed-template-template-args 
